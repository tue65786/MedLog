...
//  CREATE_PROCEDURE - dbo.spDietaryRestrictionDelete
    /**
     * Select Diary Entries<ol><li>Id</li> <li> PatientID int</li><li>Keyword
     * (null)</li></ol>
     */
    public static final String SP_DIARY_SELECT = "{call [spDiarySelect](?,?,?)}";
    /**
     * Select Healthcare provider Entries <b>Params:</b><ol><li>DoctorId
     * int</li> <li> PatientID int</li><li>Keyword (null)</li></ol>
     * <b>Result Set</b>
     * <ol><li> [PhysicianID]
     * </li><li>	[lastname]
     * </li><li>	[firstname]
    ...
    public static final String SP_HEALTHCARE_INSERT = "{call [dbo].[spHealthcareProviderInsert]("
            ...
            + "?,?,?,?)}";
    /**
     * Update {@linkplain HealthcareProviderVO} Params:
    ...
    /**
     * Assigns / Removes {@linkplain PatientVO} to/from
     * {@linkplain HealthcareProviderVO} Params: <ol>
     * <li>PatientID</li>
     * <li>HealthCareID</li>
     * <li>Assign?</li>
     * </ol>
    ...
    /**
     * INSERT PATIENT STORED PROCEDURE. Param:
     ...
     * </li><li>@userRole int = NULL , </li><li>@inserted INT OUTPUT</li></ol>
     */
    ...
    public static final String SP_PHARM_INSERT = "{call [spPharma_RX_OTCInsert]("
            ...
            + "?,?,?,?,?)}";
    /**
     * @keyword nvarchar (128) , @pageNum int = 1 , @pageSize int = 100 ,
     * @onlyMyRX bit = 0 , @PatientID int = 2--null
     */
     ...
     * </li><li>d.PharmID
     * </li><li>d.MedType
     * </li><li>d.RXCUI --</li><li>d.GENERIC_RXCUI
     * </li><li>d.TTY
